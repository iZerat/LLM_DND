...
class NPCTemplate(ResourceObject):
    ...
    def schema(cls) -> ResourceSchema:
        return ResourceSchema(fields=[
            ...
            FieldSpec("level", "等级", type=TYPE_INT, min_value=1, max_value=20, required=False, default=1),
            ...
            FieldSpec("ac", "护甲等级", type=TYPE_INT, min_value=1, required=False, default=10),
