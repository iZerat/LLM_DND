...
SPECIES_LIST: list[Species] = [
    Species(name="龙裔", size_options=["中型"], speed=30,
        traits=["黑暗视觉：60尺", "龙族先祖（自选一种龙类决定吐息伤害类型与抗性）", "吐息武器：15尺锥形/30尺线形，DC=8+体质调整+熟练，1d10伤害", "伤害抗性：根据龙族先祖类型", "5级：龙翼飞行（附赠动作，10分钟飞行）"],
        skill_choices=0),
    Species(name="矮人", size_options=["中型"], speed=30,
        traits=["黑暗视觉：120尺", "矮人韧性：毒素伤害抗性，中毒豁免优势", "矮人体魄：HP上限+1，每级再+1", "石之感应：附赠动作获得60尺震颤感知10分钟"],
        skill_choices=0),
    Species(name="精灵", size_options=["中型"], speed=30,
        traits=["黑暗视觉：60尺", "妖精血统：魅惑豁免优势", "敏锐感官：自选获得洞察/察觉/生存之一熟练", "精制：无需睡眠，4小时长休"],
        skill_choices=1, skill_options=["洞察", "察觉", "生存"],
        has_lineage=True,
        lineages=[
            Lineage(name="黑暗精灵", traits=["黑暗视觉提升至120尺", "已知舞光术戏法", "3级获得妖火", "5级获得黑暗术"]),
            Lineage(name="高等精灵", traits=["已知魔法伎俩戏法（可每日切换为任意法师戏法）", "3级获得侦测魔法", "5级获得迷踪步"]),
            Lineage(name="木精灵", traits=["速度提升至35尺", "已知德鲁伊伎俩戏法", "3级获得大步奔行", "5级获得行动无踪"]),
        ]),
    Species(name="半身人", size_options=["小型"], speed=30,
        traits=["勇敢：恐惧豁免优势", "半身人灵巧：可通过体型大于你的生物空间", "幸运：D20投出1时可重掷", "天生隐匿：被大型以上生物遮挡时即可躲藏"],
        skill_choices=0),
    Species(name="侏儒", size_options=["小型"], speed=30,
        traits=["黑暗视觉：60尺", "侏儒狡黠：智力/感知/魅力豁免优势"],
        has_lineage=True,
        lineages=[
            Lineage(name="森林侏儒", traits=["已知魔法伎俩戏法", "动物交谈术：可随意准备，每日熟练次数免费施展"]),
            Lineage(name="岩石侏儒", traits=["已知修复术和魔法伎俩", "可制作小型发条装置（AC5，HP1，最多3个，持续8小时）"]),
        ]),
    Species(name="哥利亚", size_options=["中型"], speed=35,
    ...
    Species(name="人类", size_options=["中型", "小型"], speed=30,
        traits=["智勇双全：每次长休后获得英雄 inspirations", "技巧娴熟：自选一项技能熟练", "多才多艺：获得一个起源专长"],
        skill_choices=1, skill_options=SKILLS),
    Species(name="兽人", size_options=["中型"], speed=30,
        traits=["黑暗视觉：120尺", "肾上腺素爆发：附赠动作疾走，获得熟练项临时HP，熟练次数/长休", "不屈不挠：HP归0时若非即死则改为1HP，每长休一次"]),
    Species(name="提夫林", size_options=["中型", "小型"], speed=30,
        traits=["黑暗视觉：60尺", "异界存在：已知奇术戏法"],
        has_lineage=True,
        lineages=[
            Lineage(name="深渊血脉", traits=["毒素伤害抗性", "已知毒云术戏法", "3级获得疾病射线", "5级获得人类定身术"]),
            Lineage(name="冥界血脉", traits=["黯蚀伤害抗性", "已知冻寒之触戏法", "3级获得虚假生命", "5级获得衰弱射线"]),
            Lineage(name="炼狱血脉", traits=["火焰伤害抗性", "已知火焰箭戏法", "3级获得炼狱叱喝", "5级获得黑暗术"]),
        ]),
]
...
CLASS_LIST: list[ClassDef] = [
    ClassDef(name="野蛮人", hit_die=12, primary_ability=["力量"],
    ...
    ClassDef(name="吟游诗人", hit_die=8, primary_ability=["魅力"],
    ...
    ClassDef(name="牧师", hit_die=8, primary_ability=["感知"],
    ...
    ClassDef(name="德鲁伊", hit_die=8, primary_ability=["感知"],
    ...
    ClassDef(name="战士", hit_die=10, primary_ability=["力量", "敏捷"],
        saving_throws=["力量", "体质"], skill_choices=2,
    ...
    ClassDef(name="武僧", hit_die=8, primary_ability=["敏捷", "感知"],
    ...
    ClassDef(name="盗贼", hit_die=8, primary_ability=["敏捷"],
    ...
    ClassDef(name="术士", hit_die=6, primary_ability=["魅力"],
